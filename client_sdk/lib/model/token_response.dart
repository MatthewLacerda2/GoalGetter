...
class TokenResponse {
  ...
  @override
  String toString() => 'TokenResponse[accessToken=$accessToken, student=$student]';
  ...
  static TokenResponse? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        ...
        assert(json.containsKey(r'student'), 'Required key "TokenResponse[student]" is missing from JSON.');
        assert(json[r'student'] != null, 'Required key "TokenResponse[student]" has a null value in JSON.');
        return true;
      }());

      return TokenResponse(
        accessToken: mapValueOfType<String>(json, r'access_token')!,
        student: StudentResponse.fromJson(json[r'student'])!,
      );
    }
    return null;
  }
