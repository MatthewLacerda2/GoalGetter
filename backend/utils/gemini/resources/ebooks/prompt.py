def get_search_ebooks_prompt_plain_text(goal_name: str, goal_description: str, objective_name: str, objective_description: str, student_context: list[str] | None):
...
def get_search_ebooks_prompt(gemini_results_plain_text: str):
